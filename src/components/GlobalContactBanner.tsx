  ...
  return (
    <div className="border-t border-border-subtle bg-footer-bg">
      <div className="mx-auto max-w-6xl px-6 md:px-10 py-16">
        ...
        <h2 className="mt-3 text-5xl font-extrabold tracking-tight text-foreground">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-3">
          <Link
            href="/contact"
            className="rounded-full bg-accent px-6 py-3 text-sm font-bold text-on-accent hover:bg-accent-muted transition-colors"
          >
